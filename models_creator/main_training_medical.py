...
if __name__ == '__main__':
  ...
  parser.add_argument("-c", "--config", help="Configuration file in JSON format",
                      type=str, default='configurations/02_config_dif_emb_no_bot_intent_medical.txt')
  ...
  d.CreateUserLabelsVocab(fn=logger.GetDropboxDrive() +\
                      '/_doc_ro_chatbot_data/00_Corpus/00_mihai_work/20190226_Production_selection_v0_3/user_labels.txt')
  d.CreateBotLabelsVocab(fn=logger.GetDropboxDrive() +\
                         '/_doc_ro_chatbot_data/00_Corpus/00_mihai_work/20190226_Production_selection_v0_3/bot_labels.txt')
  d.GenerateLabels(logger.GetDropboxDrive() +\
                   '/_doc_ro_chatbot_data/00_Corpus/00_mihai_work/20190226_Production_selection_v0_3/labels')

  batches_train = d.GenerateBatches(logger.GetDropboxDrive() + '/_doc_ro_chatbot_data/00_Corpus/00_mihai_work/20190226_Production_selection_v0_3/texts',
                                    use_characters=True, use_labels=True, eps_words=7, eps_characters=21)
  batches_val = d.GenerateValidationBatches(logger.GetDropboxDrive() + '/_doc_ro_chatbot_data/00_Corpus/00_mihai_work/20190226_Production_selection_v0_3/validare/texte_validare',
                                            use_labels=True)
  ...
  hnet.LoadModelWeightsAndConfig('20190612_001557_02_dif_emb_no_bot_intent_epoch200_loss0.04')
