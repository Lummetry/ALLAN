...
def LoadLogger(lib_name, config_file, use_tf_keras=False, config_file_encoding=None):
  module = load_module("logger", "logger.py")
  if module is not None:
    logger = module.Logger(lib_name=lib_name, config_file=config_file, TF_KERAS=use_tf_keras,
